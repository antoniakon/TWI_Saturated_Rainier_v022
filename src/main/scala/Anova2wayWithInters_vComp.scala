...
object Anova2wayWithInters_vComp {
  ...
  // build and fit model
    ...
    /**
      ...
      */
    def addGroup(current: RandomVariable[MyStructure], i: Int, j: Int, dataMap: Map[(Int, Int), Seq[Double]]): RandomVariable[MyStructure] = {
      for {
        cur <- current
    ...
    /**
      ...
      */
    @tailrec def addAllEffRecursive(alphabeta: RandomVariable[MyStructure], dataMap: Map[(Int, Int), Seq[Double]], i: Int, j: Int): RandomVariable[MyStructure] = {
    ...
    /**
      ...
      */
    def addAllEffLoop(alphabeta: RandomVariable[MyStructure], dataMap: Map[(Int, Int), Seq[Double] ]) : RandomVariable[MyStructure] = {
      val n1 = alphabeta.value.eff1.length
      val n2 = alphabeta.value.eff2.length
    ...
    /**
      ...
      */
    def fullModel(alphabeta: RandomVariable[MyStructure], dataMap: Map[(Int, Int), Seq[Double]]) : RandomVariable[MyStructure] = {
