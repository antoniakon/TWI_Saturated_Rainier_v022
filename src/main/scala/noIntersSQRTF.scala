...
object noIntersSQRTF {
    ...
    def mainEffects(dataMap: Map[(Int, Int), List[Double]], rngS: ScalaRNG, n1: Int, n2: Int): Unit = {
      ...
      val thin = 100
      val out = model.sample(HMC(200), 10000, 10000 * thin, thin)
      ...
      def printResults(out: List[Map[String, List[Double]]]) = {
        ...
        val outputFile = new File("/home/antonia/ResultsFromCloud/CompareRainier/300519/withoutInteractions/FullResultsRainierWithoutInterHMC200SQRT010719.csv")
